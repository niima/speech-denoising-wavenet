...
class DenoisingWavenet():
    ...
    def get_target_field_indices(self):
        ...
        return range(int(target_sample_index) - int(self.half_target_field_length),
                     int(target_sample_index) + int(self.half_target_field_length) + 1)

    def get_padded_target_field_indices(self):

        target_sample_index = self.get_target_sample_index()

        return range(int(target_sample_index) - int(self.half_target_field_length) - int(self.target_padding),
                     int(target_sample_index) + int(self.half_target_field_length) + int(self.target_padding) + 1)
